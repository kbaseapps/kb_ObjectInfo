...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'kb_ObjectInfo'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from kb_ObjectInfo.kb_ObjectInfoImpl import kb_ObjectInfo  # noqa @IgnorePep8
impl_kb_ObjectInfo = kb_ObjectInfo(config)
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'kb_ObjectInfo'
        ...
        self.rpc_service.add(impl_kb_ObjectInfo.assembly_metadata_report,
        ...
        self.rpc_service.add(impl_kb_ObjectInfo.genome_report,
                             ...
                             types=[dict])
        self.method_authentication['kb_ObjectInfo.genome_report'] = 'required'  # noqa
        self.rpc_service.add(impl_kb_ObjectInfo.genomeset_report,
        ...
        self.rpc_service.add(impl_kb_ObjectInfo.featseq_report,
                             ...
                             types=[dict])
        self.method_authentication['kb_ObjectInfo.featseq_report'] = 'required'  # noqa
        self.rpc_service.add(impl_kb_ObjectInfo.protcomp_report,
